                                ...
                                <div className='flex flex-row gap-4'>
                                    <div className="flex items-center gap-3 max-sm:flex-1">
                                        ...
                                        <select
                                            ...
                                            className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-100 min-w-[100px] max-sm:flex-1 max-sm:min-w-0"
                                        >
