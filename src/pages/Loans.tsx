        ...
        <div className="flex-1 ml-0 md:ml-64 md:p-6 h-screen overflow-hidden flex flex-col max-sm:overflow-y-auto max-sm:h-svh">
          ...
          {selectedLoanId ? (
            ...
            <>
              ...
              {/* Main Content */}
              <div className="flex flex-col items-center justify-center md:flex-row gap-6 flex-1 overflow-hidden max-sm:overflow-visible max-sm:px-6">
                <div className="overflow-x-auto h-full w-full max-sm:h-auto max-sm:overflow-visible">
                  {isLoading ? (
