...
const PlanOption: React.FC<PaymentMethodSelectorProps> = ({
  ...
  const [internalStep, setInternalStep] = useState<"select" | "pay">(
    initialStep,
  );
            ...
            <div className="bg-[#F8FAFC] border border-[#F1F5F9] rounded-xl p-3 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Scale your plan as your team grows
                </p>
              </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p
                        className={`text-sm font-semibold ${selected ? "text-blue-600" : "text-gray-800"}`}
                      >
                        {option.title}
                      </p>
              ...
              <div className="flex justify-between">
                ...
                <div className="text-right">
                  <p className="font-semibold">
                    Rs. {pricePerEmployee.toFixed(2)} X {employeeCount}
                  </p>
                  <span className="font-semibold">
                    Rs. {(pricePerEmployee * employeeCount).toFixed(2)}
                  </span>
                </div>
              </div>
      ...
      {step === "pay" && (
        <div>
          <div style={{ display: value === "card" ? "block" : "none" }}>
            {/* Pass pricePerEmployee and employeeCount */}
            <PlanPaymentCard
